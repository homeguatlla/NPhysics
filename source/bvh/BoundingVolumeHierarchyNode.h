...
namespace NPhysics
{
	...
	public:
		...
		BoundingVolumeHierarchyNode(std::shared_ptr<BoundingVolumeHierarchyNode> parent, std::shared_ptr<PhysicsObject> object, std::shared_ptr<IBoundingVolume> volume);
		~BoundingVolumeHierarchyNode() = default;
	...
	private:
		...
		std::shared_ptr<BoundingVolumeHierarchyNode> mParent{ nullptr };
